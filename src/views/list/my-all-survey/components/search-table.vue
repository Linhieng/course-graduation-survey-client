...
<template>
    <div>
        ...
        <div class="row">
            <a-form-item class="flex-grow" :label="$t('问卷类型')">
            ...
            <a-form-item class="flex-grow" :label="$t('问卷状态')">
            ...
            <a-form-item class="flex-grow" :label="$t('模版类型')">
        ...
        <div class="row">
            <a-form-item style="margin-right: 20px" tooltip="点击清除则采用默认排序" :label="$t('排序方式')">
